  ...
  return (
    <div>
      <div className="flex">
        ...
        <img className="w-[480px] h-[771px] mt-[6rem] mr-[3rem] ml-[3rem]"
          src={img2} />
      </div>


      <div className="absolute">
        <img className="opacity-[30%] w-[1068.39px] h-[617px] top-[1100px]" src={img3} />

        <div className="grid red">
        <div className=" absolute  w-[928px] h-[375px] top-[4rem] ml-[27px]  z-10">
          <p className=" w-[15vw] ml-[25rem] text-2xl">Our Mission</p>

          <span className="flex justify-center grid col mt-[3.5rem] font-[Inter] text-6xl">
            <h1 className="">Every purchase</h1>
            <h2 className=" ml-[.5rem] mt-[1rem]">has a purpose</h2>
          </span>
          <p className="m-3 mt-[4rem] text-3xl">We have direct partnerships with over 320 Indian artisans and over 2000 indirectly. As a social enterprise that seeks to offer a fair-trade platform, our primary purpose is to support handicraft workers. With each purchase you make, you can help make a difference.</p>
        </div>
        </div>
